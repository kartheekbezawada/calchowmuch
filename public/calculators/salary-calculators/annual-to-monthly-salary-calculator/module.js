...
setPageMetadata(
  buildSalaryMetadata({
    ...
    appDescription:
      'Convert an annual salary into monthly pay, and estimate UK or US take-home pay after tax on it.',
    featureList: [
    ...
    keywords:
      'annual to monthly salary calculator, yearly to monthly pay, annual salary to monthly income, uk take home pay, us paycheck calculator',
