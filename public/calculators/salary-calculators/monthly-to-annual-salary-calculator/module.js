...
setPageMetadata(
  buildSalaryMetadata({
    ...
    appDescription:
      'Convert a monthly salary into annual pay, and estimate UK or US take-home pay after tax on it.',
    featureList: [
    ...
    keywords:
      'monthly to annual salary calculator, monthly pay to yearly salary, annual salary from monthly income, uk take home pay, us paycheck calculator',
...
function renderResult(result, frequency) {
  ...
  if (mode !== 'gross') {
    ...
    setText(
      outputs.breakdown,
      'Annual pay = monthly amount you entered x 12. Biweekly = annual / 26, and weekly = annual / weeks per year.'
    );
  }
