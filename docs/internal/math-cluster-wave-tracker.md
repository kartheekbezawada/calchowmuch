...
| 6 | Calculus suite | 5 | passed | none | Codex | `derivative`, `integral`, `limit`, `series-convergence`, and `critical-points` are redesign-complete. Wave 6 exit gates are complete. |
| 7 | Statistics core | 4 | passed | none | Codex | `mean-median-mode-range`, `standard-deviation`, `confidence-interval`, and `z-score` are redesign-complete. Wave 7 exit gates are complete. |
| 8 | Counting and probability | 3 | passed | none | Codex | `number-sequence`, `permutation-combination`, and `probability` are redesign-complete. Wave 8 exit gates are complete. |
| 9 | Statistics advanced | 3 | passed | none | Codex | `statistics`, `correlation`, and `regression-analysis` are redesign-complete. Wave 9 exit gates are complete. |
| 10 | Final advanced statistics | 3 | passed | none | Codex | `distribution`, `anova`, and `hypothesis-testing` are redesign-complete. Wave 10 exit gates are complete and the full 36-route math migration is closed. |
...
| 6 | `/math/calculus/series-convergence/` | `series-convergence` | `cluster-owned:math` | `redesign-complete` | `type-2` | `audited` | `redesign-complete` | `release-passed-only` | `pass` | `pass` | `pass` | `pass` | `Codex` | inline-init dependency resolved | Light math shell shipped in generated output. Static schema, convergence-test hierarchy, and scoped validations now satisfy the redesign definition. |
| 6 | `/math/calculus/critical-points/` | `critical-points` | `cluster-owned:math` | `redesign-complete` | `type-2` | `audited` | `redesign-complete` | `release-passed-only` | `pass` | `pass` | `pass` | `pass` | `Codex` | variable binding defect resolved | Light math shell shipped in generated output. Static schema, turning-point hierarchy, and scoped validations now satisfy the redesign definition. |
| 7 | `/math/mean-median-mode-range/` | `mean-median-mode-range` | `cluster-owned:math` | `redesign-complete` | `type-2` | `audited` | `redesign-complete` | `release-passed-only` | `pass` | `pass` | `pass` | `pass` | `Codex` | none | Light math shell shipped in generated output. Static schema, descriptive-statistics hierarchy, and scoped validations now satisfy the redesign definition. |
| 7 | `/math/standard-deviation/` | `standard-deviation` | `cluster-owned:math` | `redesign-complete` | `type-2` | `audited` | `redesign-complete` | `release-passed-only` | `pass` | `pass` | `pass` | `pass` | `Codex` | none | Light math shell shipped in generated output. Static schema, spread-analysis hierarchy, and scoped validations now satisfy the redesign definition. |
| 7 | `/math/confidence-interval/` | `confidence-interval` | `cluster-owned:math` | `redesign-complete` | `type-2` | `audited` | `redesign-complete` | `release-passed-only` | `pass` | `pass` | `pass` | `pass` | `Codex` | none | Light math shell shipped in generated output. Static schema, interval-estimation hierarchy, and scoped validations now satisfy the redesign definition. |
| 7 | `/math/z-score/` | `z-score` | `cluster-owned:math` | `redesign-complete` | `type-2` | `audited` | `redesign-complete` | `release-passed-only` | `pass` | `pass` | `pass` | `pass` | `Codex` | none | Light math shell shipped in generated output. Static schema, standard-score hierarchy, and scoped validations now satisfy the redesign definition. |
| 8 | `/math/number-sequence/` | `number-sequence` | `cluster-owned:math` | `redesign-complete` | `type-2` | `audited` | `redesign-complete` | `release-passed-only` | `pass` | `pass` | `pass` | `pass` | `Codex` | none | Light math shell shipped in generated output. Static schema, sequence-pattern hierarchy, and scoped validations now satisfy the redesign definition. |
| 8 | `/math/permutation-combination/` | `permutation-combination` | `cluster-owned:math` | `redesign-complete` | `type-2` | `audited` | `redesign-complete` | `release-passed-only` | `pass` | `pass` | `pass` | `pass` | `Codex` | none | Light math shell shipped in generated output. Static schema, counting-mode hierarchy, and scoped validations now satisfy the redesign definition. |
| 8 | `/math/probability/` | `probability` | `cluster-owned:math` | `redesign-complete` | `type-2` | `audited` | `redesign-complete` | `release-passed-only` | `pass` | `pass` | `pass` | `pass` | `Codex` | none | Light math shell shipped in generated output. Static schema, event-rule hierarchy, and scoped validations now satisfy the redesign definition. |
| 9 | `/math/statistics/` | `statistics` | `cluster-owned:math` | `redesign-complete` | `type-2` | `audited` | `redesign-complete` | `release-passed-only` | `pass` | `pass` | `pass` | `pass` | `Codex` | none | Light math shell shipped in generated output. Static schema, full-summary hierarchy, and scoped validations now satisfy the redesign definition. |
| 9 | `/math/statistics/correlation/` | `correlation` | `cluster-owned:math` | `redesign-complete` | `type-2` | `audited` | `redesign-complete` | `release-passed-only` | `pass` | `pass` | `pass` | `pass` | `Codex` | inline-init dependency resolved | Light math shell shipped in generated output. Static schema, relationship-strength hierarchy, and scoped validations now satisfy the redesign definition. |
| 9 | `/math/statistics/regression-analysis/` | `regression-analysis` | `cluster-owned:math` | `redesign-complete` | `type-2` | `audited` | `redesign-complete` | `release-passed-only` | `pass` | `pass` | `pass` | `pass` | `Codex` | inline-init dependency resolved | Light math shell shipped in generated output. Static schema, model-fit hierarchy, and scoped validations now satisfy the redesign definition. |
| 10 | `/math/statistics/distribution/` | `distribution` | `cluster-owned:math` | `redesign-complete` | `type-2` | `audited` | `redesign-complete` | `release-passed-only` | `pass` | `pass` | `pass` | `pass` | `Codex` | inline-init dependency resolved | Light math shell shipped in generated output. Static schema, probability-lookup hierarchy, and scoped validations now satisfy the redesign definition. |
| 10 | `/math/statistics/anova/` | `anova` | `cluster-owned:math` | `redesign-complete` | `type-2` | `audited` | `redesign-complete` | `release-passed-only` | `pass` | `pass` | `pass` | `pass` | `Codex` | inline-init dependency resolved | Light math shell shipped in generated output. Static schema, multi-group decision hierarchy, and scoped validations now satisfy the redesign definition. |
| 10 | `/math/statistics/hypothesis-testing/` | `hypothesis-testing` | `cluster-owned:math` | `redesign-complete` | `type-2` | `audited` | `redesign-complete` | `release-passed-only` | `pass` | `pass` | `pass` | `pass` | `Codex` | inline-init dependency resolved | Light math shell shipped in generated output. Static schema, decision-first test hierarchy, and scoped validations now satisfy the redesign definition. |
