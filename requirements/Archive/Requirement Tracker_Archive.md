...
# Requirement Tracker — Archive

This file contains requirements that are no longer active.

Source of truth for active work remains:

- `requirements/compliance/requirement_tracker.md` → **Active Requirements**
...
| --- | --- | --- | --- | --- | --- | --- |
| REQ-20260122-001 | Navigation Restructure - Top Level Loan Categories | — | — | — | COMPLETE | — |
| REQ-20260122-002 | Top Navigation Button Visual System | — | — | — | COMPLETE | — |
| REQ-20260122-003 | ISS-NAV-TOP-001 — Top Nav Visual Contract | — | — | — | COMPLETE | — |
| REQ-20260126-010 | Switch Calculator Navigation to Full Page Loads (MPA) | — | — | — | COMPLETE | — |
