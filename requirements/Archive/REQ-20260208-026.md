...
Calculator: Credit Card Minimum Payment Calculator
...
### Placement Rules
- H1: "Credit Card Minimum Payment Calculator" (includes primary keyword)
...
| Minimum Payment Floor | cc-min-floor | number | 25 | 0 | -- | 0.01 | Yes |
...
|----------|-------|--------|
| Card Balance | {balance} | Input |
| APR | {apr}% | Input |
| Min Payment Rate | {rate}% | Input |
| Min Payment Floor | {floor} | Input |
| First Payment | {firstPayment} | Output |
| Payoff Time | {months} months | Output |
| Total Interest | {interest} | Output |
| Total Paid | {total} | Output |
...
5. How does the minimum payment floor work?
...
- MINPAY-TEST-E2E-1: Load page, verify nav active states, fill inputs, click Calculate, verify result content.
- MINPAY-TEST-E2E-2: After Calculate, change input, verify results reset to placeholder.
- MINPAY-TEST-E2E-3: Verify explanation pane has 10 FAQ items.
