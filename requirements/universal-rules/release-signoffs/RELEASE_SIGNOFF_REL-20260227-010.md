# Release Sign-Off — REL-20260227-010

## 1) Release Identity

| Field | Value |
| :--- | :--- |
| **Release ID** | REL-20260227-010 |
...
| **A4** | **JS Discipline** | 2x2/3x3 flows validated via scoped tests | Pass |
...
- `desktop_strict`: CLS `0.000`, LCP `1264ms`, blocking CSS duration `0ms`, blocking CSS requests `0`

### Exceptions
| ID | Issue | Severity | Owner |
| :--- | :--- | :--- | :--- |
| EX-REL-20260227-010-01 | `test:isolation:scope` reported non-blocking route lookup skip for aggregate `algebra` source prefix | Low | Codex |
