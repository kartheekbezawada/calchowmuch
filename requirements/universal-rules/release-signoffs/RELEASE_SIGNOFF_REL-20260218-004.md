# Release Sign-Off — REL-20260218-004

## 1) Release Identity

| Field | Value |
| :--- | :--- |
| **Release ID** | REL-20260218-004 |
| **Release Type** | CLUSTER_ROUTE_SINGLE_CALC |
| **Scope (Global/Target)** | Scoped Only (percentage cluster + percentage-decrease calculator) |
| **Cluster ID(s)** | percentage |
| **Calculator ID (CALC)** | percentage-decrease |
| **Primary Route** | /percentage-calculators/percentage-decrease/ |
...
| D1-D4 | CWV Guard | `CLUSTER=percentage CALC=percentage-decrease npm run test:calc:cwv` | Pass |
...
| :--- | :--- | :--- |
| `npm run build:css:route-bundles` | Pass | Route bundle manifest regenerated including percentage-decrease |
| `TARGET_ROUTE=/percentage-calculators/percentage-decrease/ node scripts/generate-mpa-pages.js` | Pass | Scoped generation complete for target route |
...
| `CLUSTER=percentage CALC=percentage-decrease npm run test:calc:unit` | Pass | 1 file, 6 tests passed |
| `CLUSTER=percentage CALC=percentage-decrease npm run test:calc:e2e` | Pass | 2 specs passed |
| `CLUSTER=percentage CALC=percentage-decrease npm run test:calc:seo` | Pass | Metadata/schema/sitemap + explanation parity checks passed |
| `CLUSTER=percentage CALC=percentage-decrease npm run test:calc:cwv` | Pass | Strict mobile+desktop scoped CWV guard passed; artifact generated |
...
| :--- | :--- | :--- |
| Single-pane combined layout present | Pass | `public/percentage-calculators/percentage-decrease/index.html` includes `panel-span-all` and `calculator-page-single` |
| Scenario Summary section absent | Pass | No `Scenario Summary` in generated route |
| Results table uses PV style family | Pass | `#pctdec-explanation .pv-results-table` present |
...
| :--- | :--- | :--- |
| 200 -> 150 => 25.00% | Pass | `PDEC-TEST-E2E-1` |
| 100 -> 120 => -20.00% (increase direction) | Pass | `PDEC-TEST-E2E-1` |
| 0 -> 50 guard | Pass | `PDEC-TEST-E2E-2` |

### SEO/schema parity
| Check | Result | Evidence |
| :--- | :--- | :--- |
| Title/meta/canonical present | Pass | `PDEC-TEST-SEO-1` |
| FAQ count 10 | Pass | `PDEC-TEST-SEO-1` |
| JSON-LD contains FAQ/WebPage/SoftwareApplication/Breadcrumb | Pass | `PDEC-TEST-SEO-1` |
| Sitemap includes route | Pass | `PDEC-TEST-SEO-1` |

---

## 5) Performance (Scoped CWV)

Artifact: `test-results/performance/scoped-cwv/percentage/percentage-decrease.json`

| Profile | CLS | LCP (ms) | Blocking CSS Duration (ms) | Blocking CSS Requests | Status |
| :--- | :--- | :--- | :--- | :--- | :--- |
| `mobile_strict` (CPU 3x + Slow 4G, cache disabled) | 0.00 | 1176 | 0 | 0 | Pass |
| `desktop_strict` (CPU 6x + Slow 4G, cache disabled) | 0.00 | 1404 | 0 | 0 | Pass |
