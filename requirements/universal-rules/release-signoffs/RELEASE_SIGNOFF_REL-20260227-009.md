# Release Sign-Off — REL-20260227-009

## 1) Release Identity

| Field | Value |
| :--- | :--- |
| **Release ID** | REL-20260227-009 |
...
| **A4** | **JS Discipline** | Operation mode and division guard behavior verified | Pass |
...
- `mobile_strict`: CLS `0.000`, LCP `1184ms`, blocking CSS duration `0ms`, blocking CSS requests `0`
- `desktop_strict`: CLS `0.0059`, LCP `1296ms`, blocking CSS duration `0ms`, blocking CSS requests `0`

### Exceptions
| ID | Issue | Severity | Owner |
| :--- | :--- | :--- | :--- |
| EX-REL-20260227-009-01 | `test:isolation:scope` reported non-blocking route lookup skip for aggregate `algebra` source prefix | Low | Codex |
