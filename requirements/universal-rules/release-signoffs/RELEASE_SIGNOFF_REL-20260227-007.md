# Release Sign-Off — REL-20260227-007

## 1) Release Identity

| Field | Value |
| :--- | :--- |
| **Release ID** | REL-20260227-007 |
...
| **A4** | **JS Discipline** | Slope/distance interaction logic stable across edge cases | Pass |
...
- `mobile_strict`: CLS `0.000`, LCP `1132ms`, blocking CSS duration `0ms`, blocking CSS requests `0`
- `desktop_strict`: CLS `0.026`, LCP `1308ms`, blocking CSS duration `0ms`, blocking CSS requests `0`

### Exceptions
| ID | Issue | Severity | Owner |
| :--- | :--- | :--- | :--- |
| EX-REL-20260227-007-01 | `test:isolation:scope` reported non-blocking route lookup skip for aggregate `algebra` source prefix | Low | Codex |
