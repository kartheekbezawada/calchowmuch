...
## 22) Percentage Single-Pane Rollout Checklist (2026-03-14)
Execution note:
1. Admin-authorized layout-only rollout.
2. One calculator completed end-to-end before moving to the next.
3. No contract migration performed in this rollout.

| Calculator ID | Route | Contract State | Pane Metadata | Ad Pane State | Status |
|---|---|---|---|---|---|
| `commission-calculator` | `/percentage-calculators/commission-calculator/` | `legacy-shared` | `single` | `removed` | `audit-only done` |
| `percent-change` | `/percentage-calculators/percent-change-calculator/` | `legacy-shared` | `single` | `removed` | `done` |
| `percentage-difference` | `/percentage-calculators/percentage-difference-calculator/` | `legacy-shared` | `single` | `removed` | `done` |
| `percentage-increase` | `/percentage-calculators/percentage-increase-calculator/` | `legacy-shared` | `single` | `removed` | `done` |
| `percentage-decrease` | `/percentage-calculators/percentage-decrease-calculator/` | `legacy-shared` | `single` | `removed` | `done` |
| `percentage-composition` | `/percentage-calculators/percentage-composition-calculator/` | `legacy-shared` | `single` | `removed` | `done` |
| `reverse-percentage` | `/percentage-calculators/reverse-percentage-calculator/` | `cluster-owned:percentage` | `single` | `removed` | `done` |
| `percent-to-fraction-decimal` | `/percentage-calculators/percent-to-fraction-decimal-calculator/` | `cluster-owned:percentage` | `single` | `removed` | `done` |
| `what-percent-is-x-of-y` | `/percentage-calculators/percentage-finder-calculator/` | `cluster-owned:percentage` | `single` | `removed` | `done` |
| `percentage-of-a-number` | `/percentage-calculators/percentage-of-a-number-calculator/` | `cluster-owned:percentage` | `single` | `removed` | `done` |
| `discount-calculator` | `/percentage-calculators/discount-calculator/` | `legacy-shared` | `single` | `removed` | `done` |
| `margin-calculator` | `/percentage-calculators/margin-calculator/` | `legacy-shared` | `single` | `removed` | `done` |
| `markup-calculator` | `/percentage-calculators/markup-calculator/` | `legacy-shared` | `single` | `removed` | `done` |

## 23) Percentage Mobile And Desktop Recovery Ledger (2026-03-14)
Execution note:
1. One calculator at a time.
2. Log issues before fixes and retest before moving on.
3. Shared harness blockers stop rollout until scope is expanded.

| Calculator ID | Route | Contract State | Pre-fix Mobile Result | Pre-fix Desktop Result | Issue Summary | Fix Summary | Retest Result | Release Status |
|---|---|---|---|---|---|---|---|---|
| `commission-calculator` | `/percentage-calculators/commission-calculator/` | `legacy-shared` | Initial `test:mobile:ux` failed on input contract and tap targets; shared mobile snapshot later updated and rerun passed | `test:accessibility:ux`, `test:calc:e2e`, `test:calc:unit`, `test:calc:seo`, `test:calc:cwv` passed; `test:lighthouse:target` now writes artifacts but returns Lighthouse `NO_FCP` in headless runtime | Route-local: numeric inputs lacked `inputmode`/`max` and several controls were below `48px`; shared-harness: snapshot baseline and Lighthouse output path needed support before rerun | Added numeric mobile attrs to live and tiered inputs, increased control heights to `48px`, moved hidden radios off-screen, updated shared mobile snapshot baseline, and hardened Lighthouse output-dir creation | Green for `test:mobile:ux`, `test:accessibility:ux`, `test:calc:e2e`, `test:calc:unit`, `test:calc:seo`, `test:calc:cwv`; Lighthouse remains `NO_FCP` waiver candidate with report and error log written | `route-green-lh-waiver-candidate` |
| `percent-change` | `/percentage-calculators/percent-change-calculator/` | `legacy-shared` | Initial `test:mobile:ux` failed on missing snapshot, `10px` horizontal overflow, and missing `min/max`; final rerun passed after route fix and snapshot update | `test:accessibility:ux`, `test:calc:e2e`, `test:calc:unit`, `test:calc:seo`, `test:calc:cwv` passed after removing overflow source | Route-local: generated route still baked in `scrollbar-gutter` overflow, inputs were `46px`, and number inputs lacked `min/max` | Removed route-local scrollbar forcing in source and generated route, raised controls to `48px`, added numeric `min/max`, updated shared mobile snapshot baseline | Green for `test:mobile:ux`, `test:accessibility:ux`, `test:calc:e2e`, `test:calc:unit`, `test:calc:seo`, `test:calc:cwv`; Lighthouse not rerun yet because current blocker is the shared `NO_FCP` runtime condition | `route-green-lh-pending` |
| `percentage-difference` | `/percentage-calculators/percentage-difference-calculator/` | `legacy-shared` | Initial `test:mobile:ux` failed on missing snapshot and `10px` horizontal overflow; final rerun passed after route fix and snapshot update | `test:accessibility:ux`, `test:calc:e2e`, `test:calc:unit`, `test:calc:seo`, `test:calc:cwv` passed after removing overflow source | Route-local: generated route still baked in `scrollbar-gutter` overflow, inputs were `46px`, and number inputs lacked `min/max` | Removed route-local scrollbar forcing in source and generated route, raised controls to `48px`, added numeric `min/max`, updated shared mobile snapshot baseline | Green for `test:mobile:ux`, `test:accessibility:ux`, `test:calc:e2e`, `test:calc:unit`, `test:calc:seo`, `test:calc:cwv`; Lighthouse not rerun yet because current blocker is the shared `NO_FCP` runtime condition | `route-green-lh-pending` |
| `percentage-increase` | `/percentage-calculators/percentage-increase-calculator/` | `legacy-shared` | Initial `test:mobile:ux` failed on missing snapshot and `10px` horizontal overflow; final rerun passed after route fix and snapshot update | `test:accessibility:ux`, `test:calc:e2e`, `test:calc:unit`, `test:calc:seo`, `test:calc:cwv` passed after removing overflow source | Route-local: generated route still baked in `scrollbar-gutter` overflow, inputs were `46px`, and number inputs lacked `min/max` | Removed route-local scrollbar forcing in source and generated route, raised controls to `48px`, added numeric `min/max`, updated shared mobile snapshot baseline | Green for `test:mobile:ux`, `test:accessibility:ux`, `test:calc:e2e`, `test:calc:unit`, `test:calc:seo`, `test:calc:cwv`; Lighthouse not rerun yet because current blocker is the shared `NO_FCP` runtime condition | `route-green-lh-pending` |
| `percentage-decrease` | `/percentage-calculators/percentage-decrease-calculator/` | `legacy-shared` | Initial `test:mobile:ux` failed on missing snapshot and `10px` horizontal overflow; final rerun passed after route fix and snapshot update | `test:accessibility:ux`, `test:calc:e2e`, `test:calc:unit`, `test:calc:seo`, `test:calc:cwv` passed after removing overflow source | Route-local: generated route still baked in `scrollbar-gutter` overflow, inputs were `46px`, and number inputs lacked `min/max` | Removed route-local scrollbar forcing in source and generated route, raised controls to `48px`, added numeric `min/max`, updated shared mobile snapshot baseline | Green for `test:mobile:ux`, `test:accessibility:ux`, `test:calc:e2e`, `test:calc:unit`, `test:calc:seo`, `test:calc:cwv`; Lighthouse not rerun yet because current blocker is the shared `NO_FCP` runtime condition | `route-green-lh-pending` |
| `percentage-composition` | `/percentage-calculators/percentage-composition-calculator/` | `legacy-shared` | Initial `test:mobile:ux` failed on missing snapshot and `10px` horizontal overflow; final rerun passed after route fix and snapshot update | `test:accessibility:ux`, `test:calc:e2e`, `test:calc:unit`, `test:calc:seo`, `test:calc:cwv` passed after route and module fixes | Route-local: generated route still baked in `scrollbar-gutter` overflow, known-total and row-value inputs lacked `max`/`inputmode`, and toggle/remove/add controls were below mobile contract sizing | Removed route-local scrollbar forcing in source and generated route, added numeric attrs to known-total and composition row inputs, updated generated row markup in module, enlarged toggle/button/input controls to `48px`, updated shared mobile snapshot baseline | Green for `test:mobile:ux`, `test:accessibility:ux`, `test:calc:e2e`, `test:calc:unit`, `test:calc:seo`, `test:calc:cwv`; Lighthouse not rerun yet because current blocker is the shared `NO_FCP` runtime condition | `route-green-lh-pending` |
| `reverse-percentage` | `/percentage-calculators/reverse-percentage-calculator/` | `cluster-owned:percentage` | Initial `test:mobile:ux` failed on missing snapshot, numeric input contract gaps, and `46px` input height; final rerun passed after route fix and snapshot update | `test:accessibility:ux`, `test:calc:unit`, `test:calc:e2e`, `test:calc:seo`, and `test:calc:cwv` passed after route-local fixes; `test:lighthouse:target` now writes JSON/artifacts again but still hits shared headless `NO_FCP` runtime | Route-local: percentage/final inputs lacked `min/max` and explicit `48px` height; generated route still carried four blocking stylesheet links that broke CWV budget. Shared-harness: Lighthouse CLI `--output-path` handling was broken before rerun | Added numeric attrs and explicit `48px` input height in source and generated route, removed the generated route's blocking stylesheet links so the page relies on inline critical CSS, refreshed the shared mobile baseline, and fixed the Lighthouse harness to write output from stdout instead of the broken CLI output-path flow | Green for `test:mobile:ux`, `test:accessibility:ux`, `test:calc:unit`, `test:calc:e2e`, `test:calc:seo`, `test:calc:cwv`; Lighthouse artifacts now emit correctly but the run still ends with runtime `NO_FCP` in this headless environment | `route-green-lh-pending` |
| `percent-to-fraction-decimal` | `/percentage-calculators/percent-to-fraction-decimal-calculator/` | `cluster-owned:percentage` | Initial `test:mobile:ux` failed on missing snapshot, `10px` horizontal overflow, and a short `39px` convert button; final rerun passed after route fix and snapshot update | `test:accessibility:ux`, `test:calc:unit`, `test:calc:e2e`, `test:calc:seo`, and `test:calc:cwv` passed after route-local fixes; `test:lighthouse:target` still ends in shared headless `NO_FCP` runtime | Route-local: route CSS forced `html` scrollbar gutter causing overflow, text input was under the `48px` mobile contract, and the convert button rendered at `39px` on mobile | Removed route-local scrollbar forcing in source and generated route, raised the text input and convert button to `48px`, refreshed the shared mobile baseline, and reran the full scoped calculator suite | Green for `test:mobile:ux`, `test:accessibility:ux`, `test:calc:unit`, `test:calc:e2e`, `test:calc:seo`, `test:calc:cwv`; Lighthouse now emits artifacts correctly but still returns runtime `NO_FCP` in this headless environment | `route-green-lh-pending` |
| `what-percent-is-x-of-y` | `/percentage-calculators/percentage-finder-calculator/` | `cluster-owned:percentage` | Initial `test:mobile:ux` failed on missing snapshot plus missing numeric mobile contract on both number inputs; final rerun passed after input fix and snapshot creation | `test:accessibility:ux`, `test:calc:unit`, `test:calc:e2e`, `test:calc:seo`, and `test:calc:cwv` passed after route-local fixes; `test:lighthouse:target` still ends in shared headless `NO_FCP` runtime | Route-local: `wpxy-part` and `wpxy-whole` lacked `inputmode` and `min/max` numeric contract attributes; no shared mobile baseline existed for the route yet | Added numeric mobile attributes to both number inputs in source and generated route, allowed Playwright to generate the first shared mobile baseline, and reran the full scoped calculator suite | Green for `test:mobile:ux`, `test:accessibility:ux`, `test:calc:unit`, `test:calc:e2e`, `test:calc:seo`, `test:calc:cwv`; Lighthouse now emits artifacts correctly but still returns runtime `NO_FCP` in this headless environment | `route-green-lh-pending` |
