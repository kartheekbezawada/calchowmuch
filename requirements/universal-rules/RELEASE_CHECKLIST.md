...
### Investigation (Mobile + Desktop)
- [ ] Identify LCP element; record selector/text.
- [ ] Target mobile FCP ≤ 1800ms.
- [ ] Verify no late CSS/JS required for hero.

### Stress validation
- [ ] Run Stress (CPU 4× + Slow 3G) on mobile/desktop.
- [ ] **Criteria:** Stress LCP ≤ 2300ms (preferred).
