...
- References: transfer balance, fee amount, starting balance, promo APR, promo months, post-promo APR, payment, payoff months, total interest, total fees.
- Includes interpretation explaining promo vs post-promo cost impact.

### H3 Scenario Summary Table
| Category | Value | Source |
|----------|-------|--------|
| Transfer Balance | {balance} | Input |
| Transfer Fee | {fee}% ({feeAmount}) | Input / Output |
| Starting Balance | {startingBalance} | Output |
| Promo APR | {promoApr}% | Input |
| Promo Period | {promoMonths} months | Input |
| Post-Promo APR | {postApr}% | Input |
| Monthly Payment | {payment} | Input |
| Payoff Time | {months} months | Output |
| Total Interest | {interest} | Output |
...
Each FAQ must be in a bordered container (`.cc-bt-faq-item`). Q: bolded, A: indented. 6px gap between FAQ boxes.
