...
test.describe('Percentage Increase Calculator SEO', () => {
  test('PINC-TEST-SEO-1: metadata, schema, sitemap', async ({ page }) => {
    ...
    expect(await canonical.getAttribute('href')).toBe('https://calchowmuch.com/percentage-calculators/percentage-increase/');
