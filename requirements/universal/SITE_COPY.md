...
Calculate how much you need, spend, afford.

### Usage rules
- Must appear directly below the site title ("Calculate How Much") on the homepage shell.
...
- **Test location:** `tests/e2e/homepage-design.spec.js`
