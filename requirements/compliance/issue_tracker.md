...
| ISSUE-20260121-152000 | REQ-20260120-020 | BUILD-20260121-124003 / TEST-20260121-124035 & TEST-20260121-124430 | Logarithm calculator IDs lacked nav path entries, so shell could not load them; resolved by adding all five calculators plus navigation routes and SEO metadata, then running lint/unit/e2e tests | Codex | P1 | RESOLVED | Added `'natural-log'`, `'common-log'`, `'log-properties'`, `'exponential-equations'`, `'log-scale'` to the calculator map, created all new modules and explanations, refreshed structured-data/sitemap entries, and reran lint/unit/e2e (see TEST-20260121-124035, TEST-20260121-124430) | 2026-01-21 15:20:00 |
