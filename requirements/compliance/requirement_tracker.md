...
| REQ-20260119-008 | Number Sequence Calculator Implementation | Implement arithmetic and geometric sequence calculator. Detect sequence type, find missing terms, calculate nth term, and sum of terms. Support both arithmetic (constant difference) and geometric (constant ratio) sequences with pattern recognition. | Codex | Math/Advanced/Number Sequence page | YES | VERIFIED | 2026-01-19 | requirements/build_rules/math/MATH_ADVANCED_RULES.md | Build BUILD-20260120-132341; Test TEST-20260120-132343 passed |
