...
Exact table structure requirement:
...
Choose mode (Single, Split, Weekly)

Choose overtime rule (Daily, Weekly, Daily + Weekly)

Enter regular limits (daily hours, weekly hours)

Enter shift times, mark “Ends next day” if overnight, and select break minutes

Enable “Track night hours” if you need night shift overtime classification

Click Calculate to see total, regular, overtime, and night overtime (if enabled)
