...
| SEO | `CLUSTER=pricing npm run test:cluster:seo` | Pass | Terminal pass; `tests_specs/pricing/cluster_release/seo.cluster.spec.js` |
...
| SEO evidence | Cluster SEO run reported `Thin-content summary: evaluated=4, pass=1, warn=3, fail=0, notApplicable=0` |
