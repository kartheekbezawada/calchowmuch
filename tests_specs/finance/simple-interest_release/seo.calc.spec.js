...
test.describe('Simple Interest Calculator SEO', () => {
  test('SI-TEST-SEO-1: metadata, structured data, sitemap', async ({ page }) => {
    ...
    await expect(page).toHaveTitle('Simple Interest Calculator | Interest Earned & Final Balance');
    ...
    expect(ogTitle).toBe('Simple Interest Calculator | Interest Earned & Final Balance');
