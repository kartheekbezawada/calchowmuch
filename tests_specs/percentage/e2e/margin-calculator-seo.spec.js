...
test.describe('Margin Calculator SEO', () => {
  test('MARG-TEST-SEO-1: metadata, schema, sitemap', async ({ page }) => {
    ...
    expect(canonicalHref).toBe('https://calchowmuch.com/percentage-calculators/margin-calculator/');
    ...
    expect(sitemapText).toContain('/percentage-calculators/margin-calculator/');
  });
});
