...
test.describe('Markup Calculator SEO', () => {
  test('MARKUP-TEST-SEO-1: metadata, structured data, sitemap', async ({ page }) => {
    ...
    expect(canonicalHref).toBe('https://calchowmuch.com/percentage-calculators/markup-calculator/');
    ...
    expect(sitemapText).toContain('/percentage-calculators/markup-calculator/');
  });
});
